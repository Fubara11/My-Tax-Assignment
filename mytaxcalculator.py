def calculate_tax():
    ...
    # Tax brackets for 2009 (Upper limits for each rate)
    brackets = [
        [8350, 33950, 82250, 171550, 372950],   # Status 0: Single
        [16700, 67900, 137050, 208850, 372950], # Status 1: Married Joint
        [8350, 33950, 68525, 104425, 186475],   # Status 2: Married Separate
        [11950, 45500, 117450, 190200, 372950]  # Status 3: Head of Household
    ]
